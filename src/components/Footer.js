    ...
    <footer className="py-24 bg-white ">
      <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className="justify-between">
          ...
          <svg viewBox="0 0 123 27" class="fill-current text-black w-[115.5px] h-[24px] mx-auto lg:mx-0 cursor-pointer">
        ...
        <div className="mt-0 text-gray-500">
          <h1 className='mt-10 text-xs text-center'>© 2000 - 2024 SitePoint Pty. Ltd.</h1>
          <p className='py-1 text-xs text-end'>This site is protected by reCAPTCHA and the Google <br /> Privacy Policy and Terms of Service apply.</p>
          <a href="/" className="block mt-10 font-semibold mb-28 text-black/80 hover:text-gray-500 text-end">Back to top ↑</a>
        </div>
      </div>
    </footer>
  );
